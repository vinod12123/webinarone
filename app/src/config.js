    ...
    security: {
        ...
        host: {
            ...
            users_api_room_allowed:
                process.env.USERS_ROOM_ALLOWED_ENDPOINT || 'http://localhost:4000/api/webinars/mirotalk/isRoomAllowed',
            users_api_rooms_allowed:
                process.env.USERS_ROOMS_ALLOWED_ENDPOINT || 'http://localhost:4000/api/webinars/mirotalk/roomsAllowed',
            api_room_exists: process.env.ROOM_EXISTS_ENDPOINT || 'http://localhost:4000/api/webinars/mirotalk/roomExists',
    ...
    ui: {
        ...
        brand: {
            ...
            og: {
                ...
                siteName: process.env.OG_SITE_NAME || 'Webinar',
                title: process.env.OG_TITLE || 'Click the link to make a call.',
                description:
                    process.env.OG_DESCRIPTION || 'Webinar provides real-time video calls and screen sharing.',
                image: process.env.OG_IMAGE_URL || 'https://demo.jobprep.io/logo-jobprep.png',
                url: process.env.OG_URL || 'https://demo.jobprep.io',
            },
        ...
        buttons: {
            ...
            main: {
                ...
                endCallForEveryoneButton: process.env.SHOW_END_CALL_FOR_EVERYONE_BUTTON !== 'false',
